# OmniType ProGuard Rules

# Keep the accessibility service (instantiated by Android framework via reflection)
-keep class com.alzimerahmed.omnitype.service.AssistantService { <init>(); }

# Keep enum values used in JSON serialization via CommandType.valueOf()
-keepclassmembers enum com.alzimerahmed.omnitype.model.CommandType {
