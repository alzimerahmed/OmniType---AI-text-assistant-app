...
android {
    namespace = "com.alzimerahmed.omnitype"
    compileSdk = 37

    defaultConfig {
        applicationId = "com.alzimerahmed.omnitype"
        minSdk = 23
        targetSdk = 36
        ...
        // strings for ~30 further locales that OmniType does not translate, for ~64KB of APK
    ...
    androidResources {
        ...
        // Settings > Apps > OmniType > Language. Without it a heavily localized app is
